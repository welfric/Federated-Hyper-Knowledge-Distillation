...
from Server.ServerFedProtoChilled import ServerFedProtoChilled
...
Loaders_train, Loaders_test, global_loader_test, _ = load_and_partition_data(num_clients=args.num_clients, dataset=args.dataset, alpha=args.beta, batch_size=args.batch_size, frac=args.part, rand_seed=args.seed)
testset = _
...
if args.alg == "FedProtoChilled":
    server = ServerFedProtoChilled(args,global_model,Loaders_train,Loaders_test,global_loader_test,device)
